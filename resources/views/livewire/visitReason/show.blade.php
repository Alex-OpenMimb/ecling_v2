        ...
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-2">
                    Información detallada de la razón de visita.
                </p>
            </div>
        ...
        <div class="px-6 py-6 space-y-5">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="bg-gray-50 border border-gray-100 rounded-lg px-4 py-3">
                    ...
                    <p class="text-base font-medium text-gray-800 mt-1">{{ $visitReason->name }}</p>
                </div>

                <div class="bg-gray-50 border border-gray-100 rounded-lg px-4 py-3">
                    <p class="text-xs uppercase tracking-wide text-gray-500">Estado</p>
                    <span class="inline-flex items-center mt-1 px-3 py-1 text-sm font-semibold rounded-full {{ $visitReason->status ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700' }}">
                        {{ $visitReason->status ? 'Activo' : 'Inactivo' }}
                    </span>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="bg-gray-50 border border-gray-100 rounded-lg px-4 py-3">
                    ...
                    <p class="text-base font-medium text-gray-800 mt-1">
                        {{ optional($visitReason->created_at)->format('d/m/Y H:i') }}
                    </p>
                </div>
                ...
                <div class="bg-gray-50 border border-gray-100 rounded-lg px-4 py-3">
                    ...
                    <p class="text-base font-medium text-gray-800 mt-1">
                        {{ optional($visitReason->updated_at)->format('d/m/Y H:i') }}
                    </p>
                </div>
            </div>
        </div>

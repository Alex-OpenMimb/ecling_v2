        ...
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            <div>
                <h1 class="text-xl font-semibold text-gray-800">
                    {{ $id ? 'Editar razón de visita' : 'Crear razón de visita' }}
                </h1>
                <p class="text-sm text-gray-500 mt-1">
                    Gestiona las razones utilizadas para registrar visitas.
                </p>
            </div>
        ...
        <form wire:submit.prevent="save" class="px-6 py-6 space-y-6">
            <div>
                ...
                <input
                    ...
                    placeholder="Ingresa el nombre de la razón"
                >
                @error('name')
            ...
            <div class="flex items-center justify-between bg-gray-50 border border-gray-200 rounded-lg px-4 py-3">
                <div>
                    ...
                    <p class="text-xs text-gray-500">Define si la razón estará disponible.</p>
                </div>

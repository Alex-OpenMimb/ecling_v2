        ...
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-2">
                    Información detallada del estado de orden de servicio.
                </p>
            </div>
        ...
        <div class="px-6 py-6 space-y-5">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="bg-gray-50 border border-gray-100 rounded-lg px-4 py-3">
                    ...
                    <p class="text-base font-medium text-gray-800 mt-1">{{ $orderStatus->name }}</p>
                </div>

                <div class="bg-gray-50 border border-gray-100 rounded-lg px-4 py-3">
                    <p class="text-xs uppercase tracking-wide text-gray-500">Código</p>
                    <p class="text-base font-medium text-gray-800 mt-1">{{ $orderStatus->code }}</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="bg-gray-50 border border-gray-100 rounded-lg px-4 py-3">
                    ...
                    <span class="inline-flex items-center mt-1 px-3 py-1 text-sm font-semibold rounded-full {{ $orderStatus->state ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700' }}">
                        {{ $orderStatus->state ? 'Activo' : 'Inactivo' }}
                    </span>
                </div>

                <div class="bg-gray-50 border border-gray-100 rounded-lg px-4 py-3">
                    <p class="text-xs uppercase tracking-wide text-gray-500">Órdenes asignadas</p>
                    <p class="text-base font-medium text-gray-800 mt-1">{{ $orderStatus->service_orders_count }}</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="bg-gray-50 border border-gray-100 rounded-lg px-4 py-3">
                    ...
                    <p class="text-base font-medium text-gray-800 mt-1">
                        {{ optional($orderStatus->created_at)->format('d/m/Y H:i') }}
                    </p>
                </div>
                ...
                <div class="bg-gray-50 border border-gray-100 rounded-lg px-4 py-3">
                    ...
                    <p class="text-base font-medium text-gray-800 mt-1">
                        {{ optional($orderStatus->updated_at)->format('d/m/Y H:i') }}
                    </p>
                </div>
            </div>
        </div>

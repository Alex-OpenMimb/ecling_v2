        ...
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            <div>
                <h1 class="text-xl font-semibold text-gray-800">
                    {{ $id ? 'Editar estado de orden' : 'Crear estado de orden' }}
                </h1>
                <p class="text-sm text-gray-500 mt-1">
                    Gestiona los estados disponibles para las órdenes de servicio.
                </p>
            </div>
        ...
        <form wire:submit.prevent="save" class="px-6 py-6 space-y-6">
            ...
            <div>
                ...
                <textarea
                    ...
                    rows="4"
                    class="w-full rounded-md border border-gray-300 focus:ring-blue-500 focus:border-blue-500 text-gray-900 text-sm px-4 py-2.5"
                    placeholder="Opcional, agrega una breve descripción"
                ></textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                @enderror
            ...
            <div class="flex items-center justify-between bg-gray-50 border border-gray-200 rounded-lg px-4 py-3">
                <div>
                    ...
                    <p class="text-xs text-gray-500">Define si el estado estará disponible.</p>
                </div>
                <label class="inline-flex items-center cursor-pointer">
                    <input wire:model="state" type="checkbox" class="sr-only peer">

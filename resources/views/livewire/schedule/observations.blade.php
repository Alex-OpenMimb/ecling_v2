        ...
        <form  wire:submit.prevent="updateOrStore()" class="m-4">
            <div class="flex justify-between items-center pb-4">
                <h3 class="text-xl  text-gray-900" id="brand-modal-title"
                    {{$id}}
                > Observaciones</h3>
                <button   onclick="Livewire.dispatch('closeModal', { component: 'schedule.observations' })" type="button" class="text-gray-600 hover:text-gray-800 focus:outline-none">
            ...
            <div class="mt-6 flex justify-end space-x-4">
                ...
                <button onclick="Livewire.dispatch('closeModal', { component: 'schedule.observations' })" type="button" class="bg-white border border-red-500 text-red-500 px-4 py-2 rounded-md hover:bg-red-500 hover:text-white transition duration-300">Cancelar</button>
